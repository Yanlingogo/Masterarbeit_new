...
lbg = vertcat(zeros(4*Ngen+2*Nbus+2*Nbranch+2*Nload,1),-inf(12*Nbus+84*Nbranch+8*Ngen+2*Npq+4,1));
ubg = vertcat(zeros(4*Ngen+2*Nbus+2*Nbranch+2*Nload,1),zeros(12*Nbus+84*Nbranch+8*Ngen+2*Npq+4,1));
