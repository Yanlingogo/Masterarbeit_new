function [Psivv] = create_ineq_Psivv(Psi_u_vvcos,Psi_l_vvcos,Psi_u_vvsin,Psi_l_vvsin,Psi_u_vv,Psi_l_vv, Dvvu_uu,Dvvl_uu,Dvvl_ll, Dcuu,Dcul,Dclu,Dcll,Dsuu,Dsll, v_u,v_l,Dvu,Dvl,Psi_vvcos0,Psi_vvsin0,Psi_vv0,Phi0,v0,idx_fr,idx_to)
