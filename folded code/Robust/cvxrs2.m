function [mpc, sanity_check] = cvxrs(mpc,option,target_mpc,phase_shift)
    ...
    J_psi0 = [zeros(2*Nbus,size(idx_nslack,1)+Npq), [Cg * alpha0; zeros(Nbus,1)];
        ...
        zeros(Nbus,size(idx_nslack,1)), 2*D(:,idx_pq), zeros(Nbus,1)];% (3Nbus+2Nbranch)*(nslack+pq+1)
...
%         inf(4+8*Nbus+28*Nbranch,1),pg_max,inf(2*Nload+3*Ngen+6,1));
    ...
    % >= 0
    g_gcos11 = g_u_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_u_uu+v0(idx_fr).*v0(idx_to).*Delta_cos_u_u+1/4*(Delta_vv_u_uu+Delta_cos_u_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_u);
    g_gcos12 = g_u_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_u_uu+v0(idx_fr).*v0(idx_to).*Delta_cos_u_l+1/4*(Delta_vv_u_uu+Delta_cos_u_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_l);
    g_gcos13 = g_u_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_u_ul+v0(idx_fr).*v0(idx_to).*Delta_cos_u_u+1/4*(Delta_vv_u_ul+Delta_cos_u_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_u);
    g_gcos14 = g_u_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_u_ul+v0(idx_fr).*v0(idx_to).*Delta_cos_u_l+1/4*(Delta_vv_u_ul+Delta_cos_u_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_l);
    g_gcos15 = g_u_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_u_lu+v0(idx_fr).*v0(idx_to).*Delta_cos_u_u+1/4*(Delta_vv_u_lu+Delta_cos_u_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_u);
    g_gcos16 = g_u_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_u_lu+v0(idx_fr).*v0(idx_to).*Delta_cos_u_l+1/4*(Delta_vv_u_lu+Delta_cos_u_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_l);
    g_gcos17 = g_u_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_u_ll+v0(idx_fr).*v0(idx_to).*Delta_cos_u_u+1/4*(Delta_vv_u_ll+Delta_cos_u_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_u);
    g_gcos18 = g_u_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_u_ll+v0(idx_fr).*v0(idx_to).*Delta_cos_u_l+1/4*(Delta_vv_u_ll+Delta_cos_u_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_l);
    % <= 0
    g_gcos21 = g_l_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_l_uu+v0(idx_fr).*v0(idx_to).*Delta_cos_l_u-1/4*(Delta_vv_l_uu-Delta_cos_l_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_u);
    g_gcos22 = g_l_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_l_uu+v0(idx_fr).*v0(idx_to).*Delta_cos_l_l-1/4*(Delta_vv_l_uu-Delta_cos_l_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_l);
    g_gcos23 = g_l_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_l_ul+v0(idx_fr).*v0(idx_to).*Delta_cos_l_u-1/4*(Delta_vv_l_ul-Delta_cos_l_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_u);
    g_gcos24 = g_l_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_l_ul+v0(idx_fr).*v0(idx_to).*Delta_cos_l_l-1/4*(Delta_vv_l_ul-Delta_cos_l_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_l);
    g_gcos25 = g_l_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_l_lu+v0(idx_fr).*v0(idx_to).*Delta_cos_l_u-1/4*(Delta_vv_l_lu-Delta_cos_l_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_u);
    g_gcos26 = g_l_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_l_lu+v0(idx_fr).*v0(idx_to).*Delta_cos_l_l-1/4*(Delta_vv_l_lu-Delta_cos_l_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_l);
    g_gcos27 = g_l_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_l_ll+v0(idx_fr).*v0(idx_to).*Delta_cos_l_u-1/4*(Delta_vv_l_ll-Delta_cos_l_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_u);
    g_gcos28 = g_l_vvcos-(Psi_vvcos0+cos(Phi0).*Delta_vv_l_ll+v0(idx_fr).*v0(idx_to).*Delta_cos_l_l-1/4*(Delta_vv_l_ll-Delta_cos_l_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*cos(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*cos(Phi0)+v0(idx_fr).*v0(idx_to).*sin(Phi0).*Phi_l);
    % >= Psi_vvsin0
    g_gsin11 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_uu+v0(idx_fr).*v0(idx_to).*Delta_sin_u_u+1/4*(Delta_vv_u_uu+Delta_sin_u_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin12 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_uu+v0(idx_fr).*v0(idx_to).*Delta_sin_u_l+1/4*(Delta_vv_u_uu+Delta_sin_u_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin13 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_ul+v0(idx_fr).*v0(idx_to).*Delta_sin_u_u+1/4*(Delta_vv_u_ul+Delta_sin_u_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin14 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_ul+v0(idx_fr).*v0(idx_to).*Delta_sin_u_l+1/4*(Delta_vv_u_ul+Delta_sin_u_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin15 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_lu+v0(idx_fr).*v0(idx_to).*Delta_sin_u_u+1/4*(Delta_vv_u_lu+Delta_sin_u_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin16 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_lu+v0(idx_fr).*v0(idx_to).*Delta_sin_u_l+1/4*(Delta_vv_u_lu+Delta_sin_u_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin17 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_ll+v0(idx_fr).*v0(idx_to).*Delta_sin_u_u+1/4*(Delta_vv_u_ll+Delta_sin_u_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin18 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_ll+v0(idx_fr).*v0(idx_to).*Delta_sin_u_l+1/4*(Delta_vv_u_ll+Delta_sin_u_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    % >= Psi_vvsin0
    g_gsin21 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_uu+v0(idx_fr).*v0(idx_to).*Delta_sin_u_u+1/4*(Delta_vv_l_uu+Delta_sin_u_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin22 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_uu+v0(idx_fr).*v0(idx_to).*Delta_sin_u_l+1/4*(Delta_vv_l_uu+Delta_sin_u_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin23 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_ul+v0(idx_fr).*v0(idx_to).*Delta_sin_u_u+1/4*(Delta_vv_l_ul+Delta_sin_u_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin24 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_ul+v0(idx_fr).*v0(idx_to).*Delta_sin_u_l+1/4*(Delta_vv_l_ul+Delta_sin_u_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin25 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_lu+v0(idx_fr).*v0(idx_to).*Delta_sin_u_u+1/4*(Delta_vv_l_lu+Delta_sin_u_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin26 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_lu+v0(idx_fr).*v0(idx_to).*Delta_sin_u_l+1/4*(Delta_vv_l_lu+Delta_sin_u_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin27 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_ll+v0(idx_fr).*v0(idx_to).*Delta_sin_u_u+1/4*(Delta_vv_l_ll+Delta_sin_u_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin28 = g_u_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_ll+v0(idx_fr).*v0(idx_to).*Delta_sin_u_l+1/4*(Delta_vv_l_ll+Delta_sin_u_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    % <= Psi_vvsin0
    g_gsin31 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_uu+v0(idx_fr).*v0(idx_to).*Delta_sin_l_u-1/4*(Delta_vv_l_uu-Delta_sin_l_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin32 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_uu+v0(idx_fr).*v0(idx_to).*Delta_sin_l_l-1/4*(Delta_vv_l_uu-Delta_sin_l_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin33 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_ul+v0(idx_fr).*v0(idx_to).*Delta_sin_l_u-1/4*(Delta_vv_l_ul-Delta_sin_l_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin34 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_ul+v0(idx_fr).*v0(idx_to).*Delta_sin_l_l-1/4*(Delta_vv_l_ul-Delta_sin_l_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin35 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_lu+v0(idx_fr).*v0(idx_to).*Delta_sin_l_u-1/4*(Delta_vv_l_lu-Delta_sin_l_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin36 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_lu+v0(idx_fr).*v0(idx_to).*Delta_sin_l_l-1/4*(Delta_vv_l_lu-Delta_sin_l_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin37 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_ll+v0(idx_fr).*v0(idx_to).*Delta_sin_l_u-1/4*(Delta_vv_l_ll-Delta_sin_l_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin38 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_l_ll+v0(idx_fr).*v0(idx_to).*Delta_sin_l_l-1/4*(Delta_vv_l_ll-Delta_sin_l_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    % <= Psi_vvsin0
    g_gsin41 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_uu+v0(idx_fr).*v0(idx_to).*Delta_sin_l_u-1/4*(Delta_vv_u_uu-Delta_sin_l_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin42 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_uu+v0(idx_fr).*v0(idx_to).*Delta_sin_l_l-1/4*(Delta_vv_u_uu-Delta_sin_l_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin43 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_ul+v0(idx_fr).*v0(idx_to).*Delta_sin_l_u-1/4*(Delta_vv_u_ul-Delta_sin_l_u).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin44 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_ul+v0(idx_fr).*v0(idx_to).*Delta_sin_l_l-1/4*(Delta_vv_u_ul-Delta_sin_l_l).^2-onoff_pq(idx_fr).*v_u(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin45 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_lu+v0(idx_fr).*v0(idx_to).*Delta_sin_l_u-1/4*(Delta_vv_u_lu-Delta_sin_l_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin46 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_lu+v0(idx_fr).*v0(idx_to).*Delta_sin_l_l-1/4*(Delta_vv_u_lu-Delta_sin_l_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_u(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    g_gsin47 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_ll+v0(idx_fr).*v0(idx_to).*Delta_sin_l_u-1/4*(Delta_vv_u_ll-Delta_sin_l_u).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_u);
    g_gsin48 = g_l_vvsin-(Psi_vvsin0+sin(Phi0).*Delta_vv_u_ll+v0(idx_fr).*v0(idx_to).*Delta_sin_l_l-1/4*(Delta_vv_u_ll-Delta_sin_l_l).^2-onoff_pq(idx_fr).*v_l(idx_fr).*v0(idx_to).*sin(Phi0)-v0(idx_fr).*onoff_pq(idx_to).*v_l(idx_to).*sin(Phi0)-v0(idx_fr).*v0(idx_to).*cos(Phi0).*Phi_l);
    % >= 0
    ...
    if ~isempty(target_mpc)
        ...
        pg_target = gen_target(:,GEN_STATUS) .* gen_target(:,PG)/mpc.baseMVA;
        
        bus_target = target_mpc.bus;
        v_target = bus_target(:,VM);

        pl_target = bus_target(idx_load,PD)/mpc.baseMVA;
        ql_target = bus_target(idx_load,QD)/mpc.baseMVA;
    end
...
%     options.osqp.eps_abs = tol;
%     options.osqp.eps_rel = tol;
%     options.osqp.max_iter = 200;
%     options.osqp.verbose = false;
    ...
    if option == "margin" && isempty(target_mpc)
        ...
        g_add4 = v_u(id_gen);
        g_add5 = margin_opt;
        gfun1 = vertcat(gfun,g_add1,g_add2,g_add3,g_add4,g_add5);
        lbg = vertcat(lbg,pg0,pl0,ql0,v0(id_gen),0);
        ubg = vertcat(ubg,pg0,pl0,ql0,v0(id_gen),inf);
        ffun = gamma_opt;
        nlp = struct('x',x,'f',-ffun,'g',gfun1);
    ...
    elseif option == "margin" && ~isempty(target_mpc)
        ...
        g_add4 = v_u(id_gen);
        ffun = margin_opt;
        gfun2 = vertcat(gfun,g_add1,g_add2,g_add3,g_add4);
        lbg = vertcat(lbg,pg_target,pl_target,ql_target,v_target(id_gen));
        ubg = vertcat(ubg,pg_target,pl_target,ql_target,v_target(id_gen));
        nlp = struct('x',x,'f',-ffun,'g',gfun2);
        S = nlpsol('solver','ipopt', nlp, options);
        sol = S('x0', x0,'lbg', lbg,'ubg', ubg,...
                'lbx', lbx, 'ubx', ubx);
        status = S.stats().return_status;
        if strcmp(status, 'Solve_Succeeded')
            fprintf('%s: margin_opt = %.2f\n', status,full(sol.x(end)));
            gamma0 = full(sol.x(end));%margin_opt
            mpc.uncertainty.Sigma0 = Sigma0;
            mpc.uncertainty.gamma0 = gamma0;
        else
    ...
    elseif option == "obj"
        ...
        g_add4 = gamma_opt;  
        ffun = cost_opt;
        gfun3 = vertcat(gfun,g_add1,g_add2,g_add3,g_add4);
        lbg = vertcat(lbg,pl0,ql0,0,gamma0);
        ubg = vertcat(ubg,pl0,ql0,inf,inf);
        nlp = struct('x',x,'f',ffun,'g',gfun3);
        S = nlpsol('solver','ipopt', nlp,options);  
        sol = S('x0', x0,'lbg', lbg,'ubg', ubg,...
                'lbx', lbx, 'ubx', ubx);
        status = S.stats().return_status;
        if strcmp(status, 'Solve_Succeeded')
            %mpc.gen(:,PG) = full(sol.x(end-5-4*Ngen-2*Nload:end-5-3*Ngen-2*Nload-1))*mpc.baseMVA; 
    ...
    sanity_check.gamma_opt = result.rest(2);
    sanity_check.slack_pg = result.rest(3);
    sanity_check.slack_qg = result.rest(4);
    sanity_check.margin_opt = result.rest(6);
