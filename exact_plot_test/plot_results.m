...
%% add explanation
x_label=xlabel(['$P_{pcc,' num2str(1) '}$ (p.u.)']); set(x_label, 'Interpreter', 'latex','FontSize',20,'FontName','Times New Roman');
y_label=ylabel(['$Q_{pcc,' num2str(1) '}$ (p.u.)']); set(y_label, 'Interpreter', 'latex','FontSize',20,'FontName','Times New Roman');
title(['Feasible Region of Bus ' num2str(1) ' '],'FontSize',20,'FontName','Times New Roman');
